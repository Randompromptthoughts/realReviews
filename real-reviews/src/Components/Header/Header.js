    ...
    return (
      <section>
        <Nav className="justify-content-end" activeKey="/home">
          ...
          <Nav.Item>
            <Link to='/profile'><Nav.Link className="profile" href="/home"> <h6 className='text'>Profile</h6></Nav.Link></Link>
          </Nav.Item>
          <Nav.Item>
            <Link to='/about'><Nav.Link className='about' eventKey="link-1"> <h6 className='text'>About</h6></Nav.Link></Link>
          </Nav.Item>
          <Nav.Item>
            <Link to='/'><Nav.Link className='logout' eventKey="link-2"> <h6 className='text'>Logout</h6></Nav.Link></Link>
          </Nav.Item>
        </Nav>
        <div>
